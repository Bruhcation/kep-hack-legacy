...
; Route 19
	db 41, TENTACRUEL, PENDRAKEN, 0
	db 40, GOLDEEN, HORSEA, STARYU, 0
	db 41, WEIRDUCK, POLIWHIRL, 0
	db 39, HORSEA, TENTACOOL, TENTACOOL, GOLDEEN, 0
	db 40, GOLDEEN, SEAKING, WEIRDUCK, 0
	db 42, WUGTRIO, CLOYSTER, 0
	db 39, TENTACOOL, SLOWKING, STARYU, SEADRA, TENTACRUEL, 0
; Route 20
	db 42, SHELLDER, CLOYSTER, 0
	db 42, STARMIE, 0
	db 42, HORSEA, BLOTTLE, SEADRA, PENDRAKEN, 0
; Route 21
	db 43, SEADRA, TENTACRUEL, 0
	db 44, STARMIE, 0
	db 41, BLASTOISE, STARMIE, TOTARTLE, 0
	db 41, POLIWHIRL, TENTACOOL, GOLDUCK, 0
